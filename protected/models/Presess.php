...
/**
 * This is the model class for table "presess".
 *
 * The followings are the available columns in table 'presess':
 * @property string $total_students
 * @property string $date
 * @property integer $institute_batch_id
 */
class Presess extends CActiveRecord
{
	/**
	 ...
	 * @return Presess the static model class
	 */
