...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, email, password, username, date_registered, role, institute_industry_name, fname, lname, phone_number, dob, institute_email_address, institute, city, program, batch, is_approve, is_verified', 'safe', 'on'=>'search'),
		);
	}
