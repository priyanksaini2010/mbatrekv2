 ...
 */
class CollegesCompetition extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, sortOrder', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'campusAmbassadors' => array(self::HAS_MANY, 'CampusAmbassador', 'college_id'),
		);
	}
