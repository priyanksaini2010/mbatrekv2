...
/**
 * This is the model class for table "presess_all".
 *
 * The followings are the available columns in table 'presess_all':
 * @property string $total_students
 * @property string $date
 * @property integer $institute_batch_id
 */
class PresessAll extends CActiveRecord
{
	/**
	 ...
	 * @return PresessAll the static model class
	 */
