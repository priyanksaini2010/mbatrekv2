 ...
 * @property double $discount_availed
...
class CouponUsage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('coupon_id, email_used, users_new_id, discount_availed, date_created, cart_id', 'required'),
			array('coupon_id, users_new_id, cart_id', 'numerical', 'integerOnly'=>true),
			array('discount_availed', 'numerical'),
			array('email_used', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, coupon_id, email_used, users_new_id, discount_availed, date_created, cart_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('discount_availed',$this->discount_availed);
