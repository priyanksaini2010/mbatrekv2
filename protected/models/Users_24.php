...
class Users extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('role, is_approve, is_verified, login_count', 'numerical', 'integerOnly'=>true),
			...
			array('id, email, password, username, date_registered, role, institute_industry_name, fname, lname, phone_number, dob, institute_email_address, institute, city, program, batch, is_approve, is_verified, last_login, login_count', 'safe', 'on'=>'search'),
		);
	}
