...
/**
 * This is the model class for table "talk_to_advisory".
 *
 * The followings are the available columns in table 'talk_to_advisory':
 * @property integer $id
...
class TalkToAdvisory extends CActiveRecord
{
	 ...
	 * @return TalkToAdvisory the static model class
	 */
