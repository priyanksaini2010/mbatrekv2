...
class SuccessStoryController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SuccessStory');
	...
	{
		$model=new SuccessStory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SuccessStory']))
			$model->attributes=$_GET['SuccessStory'];
	...
	{
		$model=SuccessStory::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='success-story-form')
		{
