...
class IndustriesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','analysis'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation($model);
                if (!empty($_FILES)) {
                    $fileName = rand().str_replace(" ","", $_FILES['Industries']['name']['founder_image']); 
                    $tmp_name = $_FILES['Industries']['tmp_name']['founder_image'];
                    move_uploaded_file($tmp_name, $path."/".$fileName);
                    $_POST['Industries']['founder_image'] = $fileName;
                }
	...
	{
		$dataProvider=new CActiveDataProvider('Industries');
