                ...
                if(isset($_POST['Feedback']))
		{
			...
			if($model->save()){
                            ...
                            $body = "Hello Admin,<br/><br/>"
                                    . "New feedback recieved: <br/><br/ >"
                                    . "Email : ".$_POST['Feedback']['email']."<br/ >"
                                    . "Message : ".$_POST['Feedback']['message']."<br/ ><br/ >"
                                    . "Thanks,<br/ >"
                            ...
                            $this->redirect(Yii::app()->createUrl('site/page',array('view'=>'feedback','thank'=>1)));
                        }
		}
