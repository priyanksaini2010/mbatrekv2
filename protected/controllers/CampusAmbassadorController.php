...
//                        $this->exportCSV($model, array_keys($model->attributeLabels()), false, 3);
                        ...
                        $this->exportCSV($model->search(), array('first_name', 'last_name', 'mobile_number', 'email_id','college_id','college.name','course_id','course.title','question_1','question_2','question_3'));
                    }
