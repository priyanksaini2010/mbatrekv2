    ...
    if (isset(Yii::app()->user->id)) {
        ...
        switch ($userData->role) {
            case 1:
                ...
                $im = isset($json->profile_pic)?"assets/resumes/".$json->profile_pic:"images/defualt_user.jpg" ;
                break;
            case 2:
                $route = 'institutes/portal';
                $im = "images/who_We_1.png" ;
                break;
            case 3:
                $route = 'industry/portal';
                $industryProfile =  IndustryUser::model()->findByAttributes(array("user_id" => Yii::app()->user->id));
                $im = "assets/companylogo/".$industryProfile->industry->founder_image ;
                break;
            default :
                $route = "";
                break;
...
<nav class="first_header">
    ...
    <ul class="second_link list-unstyled list-inline">
        <li class="download_brochers sub-menu-parent <?php
			...
			<ul class="sub-menu list-unstyled">
				<li><a href="<?php echo Yii::app()->createUrl('site/page', array('view' => "download_ebrochersform")); ?>">Brochures</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('site/videos', array('view' => "videas")); ?>">Videos</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('site/articles', array('type' => "1")); ?>">Articles</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('site/page', array('view' => "handbook")); ?>">Handbook</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('site/articles', array('type' => "2")); ?>">Success Stories</a></li>
						<li><a href="<?php echo Yii::app()->createUrl('site/page', array('view' => "event_gallery")); ?>">Events Gallery</a></li>
			</ul>
		</li>
    ...
    <nav class="menu_list">
        ...
        <!-- <li><a class="raised ripple" href="signup_student.html"><i class="fa fa-user" aria-hidden="true"></i> Register</a></li> -->
                ...
                ?>"><a class="raised ripple" href="<?php echo Yii::app()->createUrl('site/blogs') ?>"><i class="fa fa-bold" aria-hidden="true"></i> Blog</a></li>
                <li class="<?php
                if ($view == 'support') {
                    echo 'active';
                }
