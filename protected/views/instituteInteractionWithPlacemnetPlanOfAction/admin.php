...
<h1>Manage Talk To Us Plan Of Actions</h1>


<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'institute-interaction-with-placemnet-plan-of-action-grid',
	...
	'columns'=>array(
		...
		array(
			...
			'updateButtonUrl' =>'$this->grid->controller->createUrl("instituteInteractionWithPlacemnetPlanOfAction/update", array("institute_batch_id"=>$_GET[\'institute_batch_id\'],"interaction_id"=>$_GET[\'interaction_id\'],"id"=>$data->id))',
		),
	),
)); ?>
