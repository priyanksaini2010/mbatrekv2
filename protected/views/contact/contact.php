                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="contact_info_div margin-0">
                                <div class="phAnimate">
                                    ...
                                    <?php if($model->first_name != ''){ $data =  array('for' => "first_name",'class' => 'active');}else{$data =  array('for' => "first_name");};?>
                        ...
                        <div class="col-md-6">
                            <div class="contact_info_div margin-0">
                                <div class="phAnimate">
                                    ...
                                    <?php if($model->last_name != ''){ $data =  array('for' => "last_name",'class' => 'active');}else{$data =  array('for' => "last_name");};?>
                        ...
                        <div class="col-md-6">
                            <div class="contact_info_div">
                                <div class="phAnimate">
                                    ...
                                    <?php if($model->email != ''){ $data =  array('for' => "email",'class' => 'active');}else{$data =  array('for' => "email");};?>
                        ...
                        <div class="col-md-6">
                            <div class="contact_info_div">
                                <div class="phAnimate">
                                    <?php if($model->mobile_no != ''){ $data =  array('for' => "mobile_no",'class' => 'active');}else{$data =  array('for' => "mobile_no");};?>
                        ...
                        <div class="col-md-12">
                            <div class="are_yu"><label>Are You?</label>
                                <ul>
                                    <li>
                                        <div class="check_box"><input id="checkboxG1" class="css-checkbox" type="checkbox" name="Contact[are_you]" value="Company Rep" /> <label class="css-label" for="checkboxG1">Company Rep</label></div>
                                    </li>
                                    <li>
                                        <div class="check_box"><input id="checkboxG2" class="css-checkbox" type="checkbox" name="Contact[are_you]" value="Institute Rep" /> <label class="css-label" for="checkboxG2">Institute Rep</label></div>
                                    </li>
                                    <li>
                                        <div class="check_box"><input id="checkboxG3" class="css-checkbox" type="checkbox" name="Contact[are_you]" value="College Student"  /> <label class="css-label" for="checkboxG3">College Student</label></div>
                                    </li>
                                    <li>
                                        <div class="check_box"><input id="checkboxG4" class="css-checkbox" type="checkbox" name="Contact[are_you]" value="Young professional"  /> <label class="css-label" for="checkboxG4">Young professional</label></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="contact_info_div">
                                <div class="phAnimate">
                                    <?php if($model->name_of_company_institute != ''){ $data =  array('for' => "name_of_company_institute",'class' => 'active');}else{$data =  array('for' => "name_of_company_institute");};?>
                        ...
                        <div class="col-md-12">
                            <div class="contact_info_div">
                                <div class="phAnimate"> 
                                    <?php if($model->subject != ''){ $data =  array('for' => "subject",'class' => 'active');}else{$data =  array('for' => "subject");};?>
                        ...
                        <div class="col-md-12">
                            <div class="contact_info_div">
                                <div class="phAnimate">
                                    <?php if($model->your_message != ''){ $data =  array('for' => "your_message",'class' => 'active');}else{$data =  array('for' => "your_message");};?>
