<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'description2',array('class'=>'span5','maxlength'=>255)); ?>
        <br />
	<?php
	...
	<div class="form-actions">
        ...
        <?php if($model->isNewRecord){?>
            ...
            <?php if($return == 0){?>
            <a href="<?php echo Yii::app()->createUrl("ProductKeyOutcome/create",array("id"=>$product_id));?>" class="btn btn-warning btn-lg">
                <span class="glyphicon glyphicon-forward"></span> Skip
            </a>
            <?php } else{?>
            <a href="<?php echo Yii::app()->createUrl("ProductEngage/admin",array("product_id"=>$modelProducts->id));?>" class="btn btn-danger btn-lg">
