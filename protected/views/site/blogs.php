...
<div class="blog_new_container">
    <div class="blog_header">
        <div class="container">
            <div class="col-md-4">
                <div class="header_btn"><a class="<?php echo $typ == 1?"active_high":"";?>" href="<?php echo Yii::app()->createUrl("site/blogs",array("type"=>1));?>">Recent Updates</a></div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="blog_block">
                            ...
                            <div class="blog_content">
                                <div class="blog_info"><a href="<?php echo Yii::app()->createUrl("site/blogdetails", array("id"=>$blog->id));?>"><?php echo $blog->title;?></a>
                                    <p><?php echo trim_text($blog->content, 80);?>.</p>
                                    <div class="blog_btn">
                                        <div class="site_btn"><a class="raised ripple has-ripple" href="<?php echo Yii::app()->createUrl("site/blogdetails", array("id"=>$blog->id));?>">Read more</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
