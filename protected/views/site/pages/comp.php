            ...
            <div class="our_company_page">
                <section class="helping_section">
                    <div class="container">
                        ...
                        <p>
                            As a recruiter or a HR lead or a hiring manger , do you feel that your new hires and younger professionals are struggling to cope with the corporate life and your company's culture.
                        </p>
                        <p>
                ...
                <section class="bulid_your_next">
                    <div class="container">
                        ...
                        <div class="student-top">
                            ...
                            <div class="icon-holder"><a id="tab1" href="javascript:void(0);"> <span class="icon"> <img src="images/company/dedicated_solution.png" alt=""> <span class="icon-title">Internship</span> </span> <span class="icon-text"> Need help in preparing for internship? <br><span style="text-decoration: underline;">Click Here</span></span> </a></div>
                            </div>
