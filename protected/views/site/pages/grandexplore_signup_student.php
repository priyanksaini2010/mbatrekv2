...
?>
<section class="banner_area grandexplore_signup_student">
    <div class="container">
        ...
        <div class="login_outer">
            <div class="login_login signup">
                 <div class="next_container">
					<img src="<?php echo Yii::app()->baseUrl;?>/images/grade_explore.png"/>
					<div class="iner_tech_logo">
						<h2>GradXplore <em>TM</em></h2>
						<span>(Graduate students)</span>
						<p> Exploring career choice & potential  </p>
					</div>
				</div>
                <div class="logo_line"></div>
            </div>
            <div class="sign_up_div">
                <h2>Grand Explorer </br> REGISTER & Verify</h2>
