            ...
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="right_sidebar ">
                    <div class="new_heading">
                        <h3>Student’s Attendance As Per Module</h3>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <?php echo $sessions->session_name;
                                            $filename = Yii::app()->baseUrl."/assets/webinar/".$sessions->session_plan_file;
                                             if(file_exists($filename) && $sessions->session_plan_file != "") {
                                           ?>
                                            <a style="color: black;" href="<?php echo Yii::app()->createUrl('site/downloadfiles', array('path' => Yii::app()->baseUrl.'/assets/webinar/'.$sessions->session_plan_file,'name'=>$sessions->session_plan_file)) ?>"><span class="glyphicon glyphicon-download"></span></a>
                                            <?php } else {?>
