...
<li><a href="<?php echo Yii::app()->createUrl('site/page', array("view"=>"comp")); ?>">Company</a></li>
<li><a href="<?php echo Yii::app()->createUrl('site/page', array("view"=>"team")); ?>">Our Team</a></li>
