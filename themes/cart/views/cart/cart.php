...
?>
				...
				<div class="need_help">
					<span>
                                            Need Help? Visit the <a target="_blank" href="<?php echo Yii::app()->createUrl("frequently-asked-questions");?>">FAQs</a> or <a target="_blank" href="<?php echo Yii::app()->createUrl("contact");?>">Contact Us</a>
					</span>
				</div>
            </div>
        </div>
